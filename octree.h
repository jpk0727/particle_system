...
namespace SpatialTest
{
    ...
    class Octree : public ISpatialStructure
    {
        ...
        public:
            ...
            //Adds the passed in list of objects to the octree
    ...
    {      
        ...
        public:
            ...
            //Adds objects to the current node
            ...
            //Checks collisions throughout the whole tree by dividing up into octants
            void CheckCollisions(std::vector<OctreeNode*>& refAncestors);
            
            /*Some particle-particle collision detection is handled here
             *Checks the passed in object against the other objects in the current node for collisions
             */
